  ...
  return (
    <div className={first ? "" : "rdp-no-anim"}>
      <div className="mt-6 text-center rdp-fade-up">
        <p className="text-[10px] uppercase tracking-[0.28em] text-[color:var(--gold-ink)]">Comunidade</p>
      ...
      <ol className="mt-8 grid gap-4 md:grid-cols-2">
        {ITEMS.map((t, i) => (
          <li key={i} className="rdp-light-card rounded-3xl p-6 rdp-fade-up" style={{ animationDelay: `${i * 60}ms` }}>
            <Quote className="h-6 w-6 text-[color:var(--gold-ink)]" />
            ...
            <div className="mt-4 flex items-center justify-between">
              ...
              <div className="flex gap-0.5 text-[color:var(--gold-ink)]">
